...
public class AutoApproveForWork {
	...
	public static void main(final String[] argv) throws Exception {
		final AutoApproveForWork sandboxApp = new AutoApproveForWork(getSandboxClient());
		sandboxApp.checkAssignment();
	}

	private final AmazonMTurk client;

	private AutoApproveForWork(final AmazonMTurk client) {
		this.client = client;
	}
